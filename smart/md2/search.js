...
api[0].list[1].list.push({
    order: '5',
    deprecated: 'false',
    url: 'http://127.0.0.1/test/add.do',
    desc: '',
});
api[0].list[1].list.push({
    order: '6',
    deprecated: 'false',
    url: 'http://127.0.0.1/test/edit.do',
    desc: '',
});
api[0].list[1].list.push({
    order: '7',
    deprecated: 'false',
    url: 'http://127.0.0.1/test/del.do',
    desc: '',
});
api[0].list.push({
    alias: 'RedisTestController',
    order: '3',
    link: '',
    desc: '',
    list: []
...
api[0].list[2].list.push({
    order: '1',
    deprecated: 'false',
    url: 'http://127.0.0.1/redis/add.do',
    desc: '',
});
api[0].list[2].list.push({
    order: '2',
    deprecated: 'false',
    url: 'http://127.0.0.1/redis/add2.do',
    desc: '',
});
api[0].list[2].list.push({
    order: '3',
    deprecated: 'false',
    url: 'http://127.0.0.1/redis/find/{userId}.do',
    desc: '',
});
api[0].list.push({
    alias: 'CustomEndpointController',
    order: '4',
    link: '',
    desc: '',
    list: []
